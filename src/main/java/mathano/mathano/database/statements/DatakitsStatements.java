...
public class DatakitsStatements {
    ...
    public static final String LOAD_KIT_CACHE = "SELECT kit_name, content FROM datakits;";

    public static final String INSERT_KIT = "INSERT INTO datakits VALUES (?, ?, ?);";

    public static final String UPDATE_KIT = "UPDATE datakits SET content = ? WHERE kit_name = ?;";

    public static final String DELETE_KIT = "DELETE FROM datakits WHERE kit_name = ?;";

    public static final String SELECT_CONTENT = "SELECT content FROM datakits WHERE kit_name = ?;";
